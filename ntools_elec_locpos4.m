...
if pos_a(1)==pos_b(1) && pos_b(2)==pos_c(2) % a/b in the same row and b/c in the same col
    Zx = [loc_a(1),loc_b(1);loc_d(1),loc_c(1)];
    Zy = [loc_a(2),loc_b(2);loc_d(2),loc_c(2)];
    Zz = [loc_a(3),loc_b(3);loc_d(3),loc_c(3)];
elseif pos_a(2)==pos_b(2) && pos_b(1)==pos_c(1) % a/b in the same col and b/c in the same row
    Zx = [loc_a(1),loc_d(1);loc_b(1),loc_c(1)];
    Zy = [loc_a(2),loc_d(2);loc_b(2),loc_c(2)];
    Zz = [loc_a(3),loc_d(3);loc_b(3),loc_c(3)];
else
    disp('Please check the initial elecs order. No grid elecs were calculated.');
    locpos = []; 
    return
end
