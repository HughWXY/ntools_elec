...
idx = contains(all_files_name,'.log','IgnoreCase',true)+...
    contains(all_files_name,'pial_surf.mat','IgnoreCase',true)+...
    contains(all_files_name,'.ppt','IgnoreCase',true)+...
    contains(all_files_name,'.pptx','IgnoreCase',true)+...
    contains(all_files_name,FileName,'IgnoreCase',true)+...
    contains(all_files_name,preop_img_file,'IgnoreCase',true)+...
    contains(all_files_name,'elec.nii.gz','IgnoreCase',true)+... % keep original elec MRI
    contains(all_files_name,'aparc','IgnoreCase',true)+... % keep aparc.annot file
    contains(all_files_name,'removed','IgnoreCase',true)+... % keep removed elec file
    contains(all_files_name,'missing','IgnoreCase',true); % keep the missing_coor.txt
